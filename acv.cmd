...
::============================================================================
::
::   Void Windows Activator
::
::   Discord Link: https://discord.gg/devoid
::      Garbage says hi <3
::
::============================================================================
...
if %_erl%==8 exit /b
if %_erl%==7 start https://discord.gg/devoid & goto :MainMenu
...
echo Check this page https://discord.gg/devoidoem-folder
)
...
echo https://discord.gg/devoidgenuine-installation-media.html
goto dk_done
)
)
...
call :dk_color %Magenta% "Download it from https://discord.gg/devoidgenuine-installation-media.html"
)
)
...
call :dk_color2 %Magenta% "Check this page for help" %_Yellow% " google.com"
)
)
...
call :dk_color2 %Magenta% "Check this page for help" %_Yellow% " https://discord.gg/devoidtroubleshoot"
)
)
...
::  5th column = Ticket signature value. It's as it is, it's not encoded. (Check https://discord.gg/devoidhwid.html#Manual_Activation to see how it's generated)
...
echo https://discord.gg/devoidkms38.html
goto dk_done
)
)
...
::  Check https://discord.gg/devoidkms38.html#Manual_Activation to see how it's generated
...
if not [%Act_OK%]==[1] (
echo.
echo In case of any issues, check https://discord.gg/devoidtroubleshoot
)
...
if %_erl%==7 exit /b
if %_erl%==6 start https://discord.gg/devoidfix-wpa-registry.html &goto at_menu
if %_erl%==5 goto:retokens
if %_erl%==4 goto:fixwmi
if %_erl%==3 goto:sfcscan
if %_erl%==2 goto:dism_rest
if %_erl%==1 start https://discord.gg/devoidtroubleshoot.html &goto at_menu
goto :at_menu
...
echo Check this page for help https://discord.gg/devoidtroubleshoot
)
%line%
